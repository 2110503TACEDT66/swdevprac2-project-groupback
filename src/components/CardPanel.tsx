...
export default function CardPanel(){
    ...
    const [hotelResponse,setHotelsResponse] = useState(null)
    ...
    //MOCK DATA    
    /*const hotelRepo = [
        {hid:"001",name:"Chulalongkorn Hotel",image:'/img/chula.jpg'}
        ,{hid:"002",name:"Rajavithi Hotel",image:'/img/rajavithi.jpg'}
        ,{hid:"003",name:"Thammasat University Hotel",image:'/img/thammasat.jpg'}
    ]*/

    if(!hotelResponse) return <div>Hotel Panel is Loading...</div>;
