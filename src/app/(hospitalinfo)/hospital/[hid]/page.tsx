...
export default async function HospitalDetailPage({params}:{params:{hid:string}}){
    ...
    const hotelDetail = await getHospital(params.hid)

    //MOCK
    /*const hotelRepo =new Map()
    hotelRepo.set("001",{name:"Chulalongkorn Hospital",image:'/img/chula.jpg'})
    hotelRepo.set("002",{name:"Rajavithi Hospital",image:'/img/rajavithi.jpg'})
    hotelRepo.set("003",{name:"Thammasat University Hospital",image:'/img/thammasat.jpg'})
    */
    return(
